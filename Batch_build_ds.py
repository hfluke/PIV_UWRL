...
def main():
    ...
    vector_files = ['July/results/video_capture_2024-07-01_12-22-37_velocimetry_results.nc']
    ...
    for vec_file in vector_files:
        ...
        UWRL_dict['ds'].to_netcdf(f"radar/{UWRL_dict['name']}_velocimetry_results.nc")
        UWRL_dict['ds'].close()
